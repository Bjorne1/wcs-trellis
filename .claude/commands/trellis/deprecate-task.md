...
Abandon a task that should not continue — wrong direction, cancelled requirement, gone obsolete — and archive it. This is **not** completion: there is no deliverable, and no code commit belongs to this flow. For work that actually finished, use /trellis:finish-work.

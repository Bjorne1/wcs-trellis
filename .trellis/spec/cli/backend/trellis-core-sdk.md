...
description: "@blulotus/trellis-core / CLI package boundary, public exports, build and versioning contracts"
paths:
  - packages/core/**
  - packages/cli/src/**
  - packages/cli/test/**
...
> Package boundary and coding rules for `@blulotus/trellis-core` and the CLI.
...
| -------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------- |
| `@blulotus/trellis-core` | Reusable domain logic, storage primitives, reducers, task APIs, channel APIs, and typed contracts.                                       |
| `@blulotus/trellis`      | CLI argument parsing, terminal rendering, command wiring, process exit behavior, template installation, migrations, and release scripts. |
...
```ts
import { createChannelStore } from "@blulotus/trellis-core/channel";
```
...
```bash
pnpm --filter @blulotus/trellis-core build
pnpm --filter @blulotus/trellis typecheck
```

...
- Codex comments now have a legacy-marker compatibility layer. The Claude statusLine constant still needs an "old OR new" branch and deprecation window when its first emission change lands.
